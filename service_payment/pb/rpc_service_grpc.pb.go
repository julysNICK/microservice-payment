...
func (c *paymentServiceClient) Hello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/service_payment.PaymentService/Hello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *paymentServiceClient) PaymentCreate(ctx context.Context, in *PaymentCreateRequest, opts ...grpc.CallOption) (*PaymentCreateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/service_payment.PaymentService/PaymentCreate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPaymentServiceServer) Hello(context.Context, *HelloRequest) (*HelloResponse, error) {
...
func _PaymentService_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/service_payment.PaymentService/Hello",
	}
...
func _PaymentService_PaymentCreate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/service_payment.PaymentService/PaymentCreate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var PaymentService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "service_payment.PaymentService",
